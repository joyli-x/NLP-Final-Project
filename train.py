...
if model_args.peft_model == "lora":
    ...
    lora_config = LoraConfig(
        task_type=TaskType.SEQ_CLS, r=model_args.r, lora_alpha=model_args.lora_alpha, lora_dropout=0.1
    )
...
# Data collator
# 如果tokenizer里面写了padding和max_pad_length,就直接用default_data_collator就可以了
